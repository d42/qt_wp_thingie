...
# Generated by qmake (2.01a) (Qt 4.8.4) on: Mon May 13 04:29:11 2013
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/qt_wp_thingie1.0.0/ && $(COPY_FILE) --parents logger.hpp logger_types.hpp settings.hpp wp_irc.hpp wp_irc_types.hpp wp_js_parser.hpp wp_js_parser_types.hpp wp_main.hpp wp_main_types.hpp wp_settings.hpp wp_settings_types.hpp wp_utils.hpp wp_utils_types.hpp .tmp/qt_wp_thingie1.0.0/ && $(COPY_FILE) --parents application.cpp logger.cpp wp_irc.cpp wp_js_parser.cpp wp_main.cpp wp_settings.cpp wp_utils.cpp .tmp/qt_wp_thingie1.0.0/ && $(COPY_FILE) --parents captcha.ui .tmp/qt_wp_thingie1.0.0/ && (cd `dirname .tmp/qt_wp_thingie1.0.0` && $(TAR) qt_wp_thingie1.0.0.tar qt_wp_thingie1.0.0 && $(COMPRESS) qt_wp_thingie1.0.0.tar) && $(MOVE) `dirname .tmp/qt_wp_thingie1.0.0`/qt_wp_thingie1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/qt_wp_thingie1.0.0
...
application.o: application.cpp logger.hpp \
		logger_types.hpp \
		wp_main.hpp \
		wp_utils.hpp \
		wp_utils_types.hpp \
