...
# Generated by qmake (2.01a) (Qt 4.8.4) on: Wed May 8 16:37:45 2013
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/qt_wp_thingie1.0.0/ && $(COPY_FILE) --parents logger.hpp logger_types.hpp settings.hpp wp_utils.hpp wp_utils_types.hpp .tmp/qt_wp_thingie1.0.0/ && $(COPY_FILE) --parents application.cpp logger.cpp wp_utils.cpp .tmp/qt_wp_thingie1.0.0/ && (cd `dirname .tmp/qt_wp_thingie1.0.0` && $(TAR) qt_wp_thingie1.0.0.tar qt_wp_thingie1.0.0 && $(COMPRESS) qt_wp_thingie1.0.0.tar) && $(MOVE) `dirname .tmp/qt_wp_thingie1.0.0`/qt_wp_thingie1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/qt_wp_thingie1.0.0
...
compiler_moc_header_make_all: moc_wp_utils.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_wp_utils.cpp
